...
parser.add_argument('ecc', metavar='e', type=float, help='eccentricity of the patches')
args = parser.parse_args()

outputFile = open('startingstate.txt','w')
args.nOSPCsPlane = args.nOSPCsSide**2
args.nOSPCs = args.nOSPCsPlane 
args.side = (args.nOSPCs/args.density)**(1./2.)
...
outputFile.write("\n" + '{:3.8f}'.format(0.0).rjust(16) +
                        '{:3.8f}'.format(1.0).rjust(16) + "     zlo zhi")
